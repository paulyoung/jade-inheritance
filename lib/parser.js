...
(function() {
  ...
  Parser = (function() {
    ...
    Parser.prototype.getInheritance = function(filename, files) {
      var branch, file, i, j, len, len1, skip, skipInheritances;
      this.addFile(filename);
      branch = {};
      ...
      for (i = 0, len = files.length; i < len; i++) {
        ...
        if (pkginfo.skipInheritances) {
          for (j = 0, len1 = skipInheritances.length; j < len1; j++) {
            skip = skipInheritances[j];
    ...
    Parser.prototype.createInheritanceObject = function(file, files, filename, branch) {
      ...
      try {
        return pugWalk(pugParser(pugLex(string, file)), (function(_this) {
